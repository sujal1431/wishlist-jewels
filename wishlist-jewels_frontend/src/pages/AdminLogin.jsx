...
import video from "../assets/video.mp4"; // jewellery video background
...
const AdminLogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    const adminEmail = "admin@wishlist.com";
    const adminPassword = "Admin@123";

    if (email === adminEmail && password === adminPassword) {
      localStorage.setItem("admin", email); // save session
      navigate("/admin-products"); // redirect to AdminProducts.jsx
    } else {
